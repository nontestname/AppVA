...
This file is intended to work with VA Java methods generated by AppVA.
"""
...
def interpret_per_method(
    ...
    *,
    ...
    workspace_root : str
        Root path of the AppVA workspace (default: "workspace").
    app_id : Optional[str]
...
def interpret_all_methods(
    ...
    *,
    ...
    print(f"[AppVA] Skill description written to: {output_path}")
